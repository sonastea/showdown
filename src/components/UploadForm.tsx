...
const UploadForm: React.FC<{ toggleActive: Function }> = ({ toggleActive }) => {
  ...
  return (
    ...
    >
      ...
      >
        <form
          className="flex flex-col flex-wrap p-2 sm:p-8 sm:justify-items-end place-content-center items-center sm:whitespace-nowrap overflow-hidden"
        ...
        >
          ...
          <button
            ...
            } rounded bg-mina p-1 m-4 sm:m-2 font-bold justify-self-center sm:justify-self-end text-mina-900 w-min`}
            type="submit"
            disabled={!image}
          >
            Upload
