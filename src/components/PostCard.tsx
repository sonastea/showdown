      ...
      <div className="flex items-start gap-3">
        ...
        <div className="flex-1 min-w-0">
          <div className="flex items-center gap-2">
            <Link href={`/profile/${post.author.id}`} className="font-semibold text-slate-900 hover:underline">
          ...
          {post.imageUrl && (
            <Link href={`/posts/${post.id}`} className="block mt-3 rounded-lg overflow-hidden border border-slate-200">
          ...
          <div className="flex items-center gap-6 mt-4 text-slate-500">
            ...
            <Link href={`/posts/${post.id}`} className="flex items-center gap-2 hover:text-slate-700">
  ...
  return (
    <div className="flex items-center">
      <button 
        ...
        aria-label="Upvote"
      >
        <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill={userVote === 1 ? "currentColor" : "none"} stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
